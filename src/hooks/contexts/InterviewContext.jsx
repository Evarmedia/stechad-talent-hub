...
export const InterviewProvider = ({ children }) => {
  ...
  const scheduleInterview = useCallback(async (interviewData) => {
    ...
    try {
      ...
      const createdInterview = await apiService.post(
        "interviews",
        newInterview
      );
  ...
  const fetchUserInterviews = useCallback(async () => {
    ...
    try {
      ...
      // Sort by date
      const sortedInterviews = interviewList.data.sort(
  ...
  const fetchAllInterviews = useCallback(async () => {
    ...
    try {
      ...
      // Sort by date
      interviewList = interviewList?.data.sort(
        (a, b) => new Date(b.date_time) - new Date(a.date_time)
      );
  ...
  const resetInterviewState = async () => {
    setAllInterviews([]);
    setInterviews([]);
